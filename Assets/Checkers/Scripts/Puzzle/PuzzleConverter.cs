...
namespace Checkers
{
    ...
    //            puzzleData.White = ConvertPuzzlePositions(format.WhitePositions, CheckerColor.White);
				//puzzleData.Black = ConvertPuzzlePositions(format.BlackPositions, CheckerColor.White);
			}
			else
			{
