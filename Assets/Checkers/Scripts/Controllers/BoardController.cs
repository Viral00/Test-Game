...
namespace Checkers
{
    public class BoardController : Singleton<BoardController>
    {
        ...
        [SerializeField]
        private Transform _checkersTrashPosition;

        private CheckerColor _choosenCheckerColor;
        public readonly IDictionary<int, CheckerVisual> _checkersViews = new Dictionary<int, CheckerVisual>();
        ...
        private void ResetCheckersPositionOnBoard()
        {
            foreach (var checkerView in Checkers)
            {
              checkerView.transform.localPosition = _checkersTrashPosition.position;
        ...
        public void SetCrownChecker(Checker checker)
        {
            ...
            if (checker.IsCrown) 
            { 
                // _checkersViews[checker.Id].ParticlePrefab.GetComponent<ParticleSystem>().Play();
            }
           view.enabled = true;
